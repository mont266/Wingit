...
export const GlobeIcon = (props) => (
  // Fix: Corrected typo in viewBox attribute. Was `viewBox="0 0 24" 24"`
...
export const EmptyStateIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"/><path d="M12 22v-2"/><path d="M12 4V2"/><path d="m22 12-2 0"/><path d="m4 12-2 0"/></svg>
);
...
export const PlaneTakeoffIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 22h20"/><path d="M6.36 17.4 4 19l-2-2 1.6-2.36"/><path d="m13.41 19.56 3.18-3.18-2.26-4.32 2.3-2.3.9 4.13 4.13.9-2.3 2.3-4.32-2.26-3.18 3.18c-.4.4-1.05.4-1.46 0l-1.41-1.41a1 1 0 0 1 0-1.46Z"/></svg>
);

export const PlaneLandingIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 22h20"/><path d="M11.25 2.52 7.12 15.42a2 2 0 0 0 1.8 2.58h5.66a2 2 0 0 0 1.8-2.58L12.75 2.52a2 2 0 0 0-3.5 0Z"/><path d="M8.5 16.5a2.5 2.5 0 0 1-5 0V15"/><path d="M15.5 16.5a2.5 2.5 0 0 0 5 0V15"/></svg>
);
...
export const AirlineIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 21h-14a2 2 0 0 1-2-2v-10a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2Z"></path><path d="M15 7H9v-2a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2Z"></path></svg>
);

export const AircraftIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"/></svg>
);
...
export const SeatIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M7 21a1 1 0 0 1-1-1v-5a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1H7z"/>
    <path d="M17 14V9a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v5"/>
    <path d="M14 3h-4"/>
    <path d="M12 3v4"/>
    <path d="M7 14v-2"/>
    <path d="M17 14v-2"/>
